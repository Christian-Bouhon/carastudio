...
rs_adobe_rgb_class_init(RSAdobeRGBClass *klass)
{
	...
	klass->icc_profile = rs_icc_profile_new_from_file(rs_reloc(PACKAGE_DATA_DIR G_DIR_SEPARATOR_S PACKAGE G_DIR_SEPARATOR_S "profiles" G_DIR_SEPARATOR_S "compatibleWithAdobeRGB1998.icc"));
	klass->icc_profile_linear = rs_icc_profile_new_from_file(rs_reloc(PACKAGE_DATA_DIR G_DIR_SEPARATOR_S PACKAGE G_DIR_SEPARATOR_S "profiles" G_DIR_SEPARATOR_S "compatibleWithAdobeRGB1998-linear.icc"));
}
