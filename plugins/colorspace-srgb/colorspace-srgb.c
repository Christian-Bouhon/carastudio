...
rs_srgb_class_init(RSSrgbClass *klass)
{
	...
	klass->icc_profile = rs_icc_profile_new_from_file(rs_reloc(PACKAGE_DATA_DIR G_DIR_SEPARATOR_S PACKAGE G_DIR_SEPARATOR_S "profiles" G_DIR_SEPARATOR_S "sRGB.icc"));
	klass->icc_profile_linear = rs_icc_profile_new_from_file(rs_reloc(PACKAGE_DATA_DIR G_DIR_SEPARATOR_S PACKAGE G_DIR_SEPARATOR_S "profiles" G_DIR_SEPARATOR_S "sRGB-linear.icc"));
}
